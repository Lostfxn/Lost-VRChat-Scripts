...
using System.IO;
using System.Linq;
using static Lost.HierarchyPlus.SavedSettings;
using static Lost.HierarchyPlus.StylesContainer;

namespace Lost.HierarchyPlus
{
    public class HierarchyPlus : EditorWindow
    {
        ...
        #region Window
        [MenuItem("LostTools/HierarchyPlus", false, 366)]
		...
		private static void w_Credit()
        {
	        ...
	        {
		        if (GUILayout.Button(new GUIContent("♡", ""), Styles.faintLinkLabel))
			        Application.OpenURL("");
