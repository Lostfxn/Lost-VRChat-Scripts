...
// 👉 Your VCC listing URL
const LISTING_URL = "https://raw.githubusercontent.com/Lostfxn/Lost-VRChat-Scripts/main/vcc-repo.json";

// 👉 Your packages (pulled from your repo, can add more later)
const PACKAGES = {
  "com.lost.hierarchyplus": {
    name: "com.lost.hierarchyplus",
    displayName: "Lost.HierarchyPlus",
    description: "A general improvement to the Unity hierarchy with component icons, guide lines, row coloring and customization options.",
    version: "1.8.0",
    author: {
      name: "Lost",
      url: "", // link to your site or GitHub if you want
    },
    dependencies: {
      // Fill in if you add vpmDependencies later, e.g.:
      // "com.vrchat.avatars": "^3.4"
    },
    keywords: [
      "hierarchy",
      "editor",
    ...
    license: "CC0-1.0",
    licensesUrl: "https://github.com/Lostfxn/Lost-VRChat-Scripts/blob/main/LICENSE",
  },

  // Add more packages like this when you have them:
  /*
  "com.lost.yournexttool": {
    name: "com.lost.yournexttool",
    displayName: "Lost.YourNextTool",
